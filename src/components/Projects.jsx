...
const Projects = () => {
  return (
    <section id="projects" className="max-w-lg mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
      <h2 className="text-center text-2xl md:text-3xl font-semibold text-gray-800 mb-6">Projects</h2>
